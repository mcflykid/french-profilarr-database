...
|------|---------|----------------------|
| 2026-07 | **SUPPLY 4800 → 4000** | **Correction de diagnostic** : SUPPLY ne fait pas d'erreur — il nomme sobrement (`MULTi.1080p.WEB.H265-SUPPLY`, vérifié sur Torr9) et son `.mkv` suit cette convention. C'est **C411 qui enrichit le titre** (+`VFF` +`EAC3.5.1` = **+1850 mesuré**) sans renommer le fichier → score C411 gonflé qui ne survit pas à l'import (moteur du churn HotD). Le −800 compense en partie : SUPPLY-C411-H264 (11350) ne dépasse plus une clean H265 type ENIGMA (11500), et la bibliothèque **converge** vers ENIGMA au lieu de rester bloquée sur le gros H264. Leur H265 / 4K DV restent devant (Silo ≈ 17 200) |
