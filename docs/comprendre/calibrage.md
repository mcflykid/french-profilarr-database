...
|------|---------|----------------------|
| 2026-09-23 | **Version 2.0.6 — exclusions et durées** | WebVision, AgroaQc, kORE, R3Z, Arkas, FYR3N exclus via FR-Blockers sur dix profils ; k0RE conservé. 37 tests synthétiques ajoutés (592 ops/11), 751 contrôles transversaux. [Durées de neuf films](tailles-c411-2026-09-23.md) : douze tailles C411 recalculées avec marges, 48 comparaisons + deux mutations ; bornes 17–250 et preferred conservés. Documentation synchronisée. Aucun fichier existant supprimé. Pull → Compile → Sync. |
| 2026-09-23 | **Version 2.0.5 — SpK79 et langue HYBRID** | SpK79 ajouté à **+5400** sur les dix profils, sous QTZ +5500 ; bonus QTZ+4KLight Films-4K inchangé. Aliens `MULTi.HYBRiD.VFF` corrigé : **19400** (+1500). Deuxième capture C411 conservée : 26 titres au total, 497 contrôles de tags/scores, 27 nouveaux cas ops/11 (555 au total). DV/HDR10Plus/4KLight/EAC3 déjà reconnus, pas de bonus inventé en leur absence. Bornes de taille, audio et upgrades inchangés. [Détails](spk79-2026-09-23.md). Pull → Compile → Sync. |
| 2026-09-23 | **14 titres C411 et leurs tailles** | [Échantillon détaillé](c411-2026-09-23.md), de 3,5 à 12 Go : titres et tailles arrondies conservés, analyse du profil Films-4K. Les trois paires favorisent EAC3 5.1 ; défaut repéré sur `MULTi.HYBRiD.VFF` d'Aliens (−1500 points de langue), documenté mais non corrigé dans ce complément. Aucune modification des scores/règles/bornes ; pas de verdict taille sans durée. Version 2.0.4 conservée. |
...
| 2026-09 | **Version 2.0.3** | Publication du correctif d'ordre des qualités, avec contrôle d'intégrité et test de régression parser dédiés. Après Sync, vérifier que le haut de chaque profil est bien sa qualité cible. |
