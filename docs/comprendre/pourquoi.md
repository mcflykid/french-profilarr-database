...
| **Quelle solution ?** | Des **Custom Formats** (points sur le nom de fichier) + **tailles** cibles + **8 profils** `FR-*`, calibrés sur de **vraies releases** (C411, Torr9, …). |
...
| [profils.md](../installer/profils.md) | Liste des 8 profils `FR-*` |
