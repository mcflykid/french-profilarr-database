...
CHECKS = (
    ...
    ("Conformité doc Profilarr v2 / PCD", "audit_pcd_docs.py"),
    ("Fonctionnel par fichier (post-compile)", "verify_functional.py"),
    ("Liens docs / fichiers cités", "verify_docs_links.py"),
)
