...
REGEX_DESCRIPTIONS: dict[str, str] = {
    ...
    "FR-Regex-VF2": "Tags VF2, VFQ, VOQ : MULTI.VF2, MULTIVF2 collé (C411), etc.",
    "FR-Regex-VFF": "Tags FR hors VF2/VFQ : VFF, MULTI.VFF, MULTIVFF collé (C411), VFI, FRENCH, etc.",
    ...
    "Neostark": "Groupe Neostark — bonus équipe si 4KLight dans le titre (CF FR-Team-Neostark).",
    "QTZ": "Groupe QTZ — référence 4KLight. Lié au CF FR-Team-QTZ.",
    "SpK79": "Groupe SpK79 en suffixe ou groupe analysé exact, hors noms voisins. Préférence sous QTZ.",
    "SUPPLY": "Groupe SUPPLY — WEB 2160p premium. Lié au CF FR-Team-SUPPLY.",
    "Slay3R": "Groupe Slay3R — WEB 1080p/2160p/720p C411 (H264/H265). Lié au CF FR-Team-Slay3R.",
    ...
    "Winks": "Groupe Winks — 1080p BluRay/WEB x265 MULTI (C411). Lié au CF FR-Team-Winks.",
...
CF_DESCRIPTIONS: dict[str, str] = {
    ...
    "FR-4KLight": "Tag 4KLight (Bluray UHD allégé). Fort bonus 4K (+3000) : prioritaire sur WEBRip seul.",
    ...
    "FR-MULTI-VF2": "MULTI + VF2 (dual FR+QC). Meilleur palier langue.",
    "FR-MULTI-VFF": "MULTI + précision FR C411 (VFF, VOF, VFI, TRUEFRENCH, MULTI.FRENCH). Pas de MULTI seul.",
    "FR-MULTI-VFQ": "MULTI + VFQ/VOQ/CA (Québec). Repli sous VFF seul.",
    "FR-MULTI-ambig": "MULTI seul : plusieurs langues dont FR, sous-tag FR absent (indexeurs hors C411).",
    "FR-VFQ": "VFQ/VOQ/CA sans MULTI. Repli Québec sous VFF.",
    ...
    "FR-Team-SpK79": "Équipe SpK79 — préférence utilisateur pour les encodes C411, sous QTZ. Le tag 4KLight reste un bonus distinct.",
    "FR-Team-Neostark": "Équipe Neostark — bonus 5300 uniquement si tag 4KLight dans le titre (C411).",
    "FR-Team-SUPPLY": "Équipe SUPPLY — WEB 2160p premium H265/DV/Atmos. Fort bonus 4K.",
    "FR-Team-Slay3R": "Équipe Slay3R — WEB 1080p/2160p/720p C411 (H264/H265, exclus).",
    ...
    "FR-Team-Winks": "Équipe Winks — 1080p BluRay/WEB x265 MULTI (~4–5,5 Go). Référence C411.",
    "Dolby Digital +": "Dolby Digital Plus (DD+, E-AC-3, EAC3.5.1 Torr9/C411). Distinct du Dolby Digital classique.",
    "Dolby Digital": "Dolby Digital classique (DD, AC-3, AC3.5.1 Torr9/C411). Exclut E-AC-3/EAC3 (DD+).",
    "FR-Tier-01": "Palier 01 encodeurs (BOUBA, …). Sous les équipes FR-Team (Neostark exclu).",
