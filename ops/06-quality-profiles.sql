...
-- Seuils : minimum 400/500 ; upgrade_until 60000 ; increment 1400 (anti-churn renforcé 2026-07 : re-téléchargement seulement pour un gain ≥ 1400 CF ≈ un palier de langue complet. Bloque les boucles grab-vs-import où une release au titre gonflé — ex. SUPPLY H264 VFF au grab mais .mkv générique à l'import — ping-pong avec une release stable. Protège ratio et cross-seed). Langue 1er tri (8k max), équipe/HDR/son dominant (2026-05).
INSERT INTO quality_profiles (name, description, upgrades_allowed, minimum_custom_format_score, upgrade_until_score, upgrade_score_increment) VALUES ('FR-Anime-1080p', 'Profil Sonarr 1080p — animé, trackers FR. Objectif : 1080p efficient, HDTV-1080p, Season Pack. Fallback 720p si aucune release 1080p (upgrade auto). Exclut : Remux, Full Disc, AV1, Upscaled.', 1, 0, 60000, 1400);
...
INSERT INTO quality_profiles (name, description, upgrades_allowed, minimum_custom_format_score, upgrade_until_score, upgrade_score_increment) VALUES ('FR-Series-720p', 'Profil Sonarr 720p — séries sur trackers FR. Objectif : 720p compact, HDTV-720p, Season Pack. Exclut : Remux, AV1, Upscaled.', 1, 0, 60000, 1400);
...
FROM quality_profiles qp WHERE qp.name = 'FR-Anime-1080p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Anime-1080p', 'FR-Team-SpK79', 'all', 5400
FROM quality_profiles qp WHERE qp.name = 'FR-Anime-1080p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Anime-1080p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Anime-1080p', 'FR-Audio-71', 'all', -800
FROM quality_profiles qp WHERE qp.name = 'FR-Anime-1080p';
...
FROM quality_profiles qp WHERE qp.name = 'FR-Anime-1080p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Anime-1080p', 'FR-Lourd-Episode-1080p', 'sonarr', -1200
FROM quality_profiles qp WHERE qp.name = 'FR-Anime-1080p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Anime-4K';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Anime-4K', 'FR-Team-SpK79', 'all', 5400
FROM quality_profiles qp WHERE qp.name = 'FR-Anime-4K';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Anime-4K';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Anime-4K', 'FR-Audio-71', 'all', -800
FROM quality_profiles qp WHERE qp.name = 'FR-Anime-4K';
...
FROM quality_profiles qp WHERE qp.name = 'FR-Anime-4K';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Anime-4K', 'FR-Lourd-Episode-1080p', 'sonarr', -1200
FROM quality_profiles qp WHERE qp.name = 'FR-Anime-4K';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Anime-720p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Anime-720p', 'FR-Team-SpK79', 'all', 5400
FROM quality_profiles qp WHERE qp.name = 'FR-Anime-720p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Anime-720p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Anime-720p', 'FR-Audio-71', 'all', -800
FROM quality_profiles qp WHERE qp.name = 'FR-Anime-720p';
...
FROM quality_profiles qp WHERE qp.name = 'FR-Films-1080p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Films-1080p', 'FR-Team-SpK79', 'all', 5400
FROM quality_profiles qp WHERE qp.name = 'FR-Films-1080p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Films-1080p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Films-1080p', 'FR-Audio-71', 'all', -800
FROM quality_profiles qp WHERE qp.name = 'FR-Films-1080p';
...
FROM quality_profiles qp WHERE qp.name = 'FR-Films-4K';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Films-4K', 'FR-Team-SpK79', 'all', 5400
FROM quality_profiles qp WHERE qp.name = 'FR-Films-4K';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Films-4K';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Films-4K', 'FR-Audio-71', 'all', -800
FROM quality_profiles qp WHERE qp.name = 'FR-Films-4K';
...
FROM quality_profiles qp WHERE qp.name = 'FR-Films-4K';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Films-4K', 'FR-Lourd-2160p', 'radarr', -1200
FROM quality_profiles qp WHERE qp.name = 'FR-Films-4K';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Films-4K', 'FR-Tres-Lourd-2160p', 'radarr', -1800
FROM quality_profiles qp WHERE qp.name = 'FR-Films-4K';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Series-1080p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Series-1080p', 'FR-Team-SpK79', 'all', 5400
FROM quality_profiles qp WHERE qp.name = 'FR-Series-1080p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Series-1080p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Series-1080p', 'FR-Audio-71', 'all', -800
FROM quality_profiles qp WHERE qp.name = 'FR-Series-1080p';
...
FROM quality_profiles qp WHERE qp.name = 'FR-Series-1080p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Series-1080p', 'FR-Lourd-Episode-1080p', 'sonarr', -1200
FROM quality_profiles qp WHERE qp.name = 'FR-Series-1080p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Series-4K';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Series-4K', 'FR-Team-SpK79', 'all', 5400
FROM quality_profiles qp WHERE qp.name = 'FR-Series-4K';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Series-4K';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Series-4K', 'FR-Audio-71', 'all', -800
FROM quality_profiles qp WHERE qp.name = 'FR-Series-4K';
...
FROM quality_profiles qp WHERE qp.name = 'FR-Series-4K';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Series-4K', 'FR-Lourd-Episode-1080p', 'sonarr', -1200
FROM quality_profiles qp WHERE qp.name = 'FR-Series-4K';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Series-720p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Series-720p', 'FR-Team-SpK79', 'all', 5400
FROM quality_profiles qp WHERE qp.name = 'FR-Series-720p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Series-720p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Series-720p', 'FR-Audio-71', 'all', -800
FROM quality_profiles qp WHERE qp.name = 'FR-Series-720p';
...
FROM quality_profiles qp WHERE qp.name = 'FR-Films-720p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Films-720p', 'FR-Team-SpK79', 'all', 5400
FROM quality_profiles qp WHERE qp.name = 'FR-Films-720p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Films-720p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Films-720p', 'FR-Audio-71', 'all', -800
FROM quality_profiles qp WHERE qp.name = 'FR-Films-720p';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
-- FR-Films-Any restauré (Radarr exige un minimum de profils) — échelle complète SD < 720p < 1080p < 2160p (cutoff).
INSERT INTO quality_profiles (name, description, upgrades_allowed, minimum_custom_format_score, upgrade_until_score, upgrade_score_increment) VALUES ('FR-Films-Any', 'Profil Radarr « toute qualité » — secours sur trackers FR. Objectif : tout format accepté, du SD au 2160p (cutoff), upgrade auto vers la 4K. Échelle : SD < 720p < 1080p < 2160p. Exclut : Remux, Full Disc, AV1, Upscaled (encodes uniquement).', 1, 0, 60000, 1400);
INSERT OR IGNORE INTO quality_profile_tags (quality_profile_name, tag_name)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Films-Any';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Films-Any', 'FR-Team-SpK79', 'all', 5400
FROM quality_profiles qp WHERE qp.name = 'FR-Films-Any';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Films-Any', 'FR-Team-Neostark', 'all', 5300
FROM quality_profiles qp WHERE qp.name = 'FR-Films-Any';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Films-Any';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Films-Any', 'FR-Audio-71', 'all', -800
FROM quality_profiles qp WHERE qp.name = 'FR-Films-Any';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Films-Any';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Films-Any', 'FR-Lourd-2160p', 'radarr', -1200
FROM quality_profiles qp WHERE qp.name = 'FR-Films-Any';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
SELECT 'FR-Films-Any', 'FR-Tres-Lourd-2160p', 'radarr', -1800
FROM quality_profiles qp WHERE qp.name = 'FR-Films-Any';
INSERT INTO quality_profile_custom_formats (quality_profile_name, custom_format_name, arr_type, score)
...
FROM quality_profiles qp WHERE qp.name = 'FR-Films-Any';
INSERT INTO quality_groups (quality_profile_name, name)
SELECT 'FR-Films-Any', 'SD Fallback' FROM quality_profiles qp WHERE qp.name = 'FR-Films-Any';
INSERT INTO quality_groups (quality_profile_name, name)
SELECT 'FR-Films-Any', '720p Fallback' FROM quality_profiles qp WHERE qp.name = 'FR-Films-Any';
INSERT INTO quality_groups (quality_profile_name, name)
SELECT 'FR-Films-Any', '1080p Fallback' FROM quality_profiles qp WHERE qp.name = 'FR-Films-Any';
INSERT INTO quality_groups (quality_profile_name, name)
SELECT 'FR-Films-Any', '2160p Quality' FROM quality_profiles qp WHERE qp.name = 'FR-Films-Any';
INSERT INTO quality_group_members (quality_profile_name, quality_group_name, quality_name, position)
SELECT 'FR-Films-Any', 'SD Fallback', q.name, 0 FROM qualities q WHERE q.name = 'Unknown';
INSERT INTO quality_group_members (quality_profile_name, quality_group_name, quality_name, position)
SELECT 'FR-Films-Any', 'SD Fallback', q.name, 1 FROM qualities q WHERE q.name = 'SDTV';
INSERT INTO quality_group_members (quality_profile_name, quality_group_name, quality_name, position)
SELECT 'FR-Films-Any', 'SD Fallback', q.name, 2 FROM qualities q WHERE q.name = 'DVD';
INSERT INTO quality_group_members (quality_profile_name, quality_group_name, quality_name, position)
SELECT 'FR-Films-Any', 'SD Fallback', q.name, 3 FROM qualities q WHERE q.name = 'WEBDL-480p';
INSERT INTO quality_group_members (quality_profile_name, quality_group_name, quality_name, position)
SELECT 'FR-Films-Any', '720p Fallback', q.name, 0 FROM qualities q WHERE q.name = 'Bluray-720p';
INSERT INTO quality_group_members (quality_profile_name, quality_group_name, quality_name, position)
SELECT 'FR-Films-Any', '720p Fallback', q.name, 1 FROM qualities q WHERE q.name = 'WEBDL-720p';
INSERT INTO quality_group_members (quality_profile_name, quality_group_name, quality_name, position)
SELECT 'FR-Films-Any', '720p Fallback', q.name, 2 FROM qualities q WHERE q.name = 'WEBRip-720p';
INSERT INTO quality_group_members (quality_profile_name, quality_group_name, quality_name, position)
SELECT 'FR-Films-Any', '720p Fallback', q.name, 3 FROM qualities q WHERE q.name = 'HDTV-720p';
INSERT INTO quality_group_members (quality_profile_name, quality_group_name, quality_name, position)
SELECT 'FR-Films-Any', '1080p Fallback', q.name, 0 FROM qualities q WHERE q.name = 'Bluray-1080p';
INSERT INTO quality_group_members (quality_profile_name, quality_group_name, quality_name, position)
SELECT 'FR-Films-Any', '1080p Fallback', q.name, 1 FROM qualities q WHERE q.name = 'WEBDL-1080p';
INSERT INTO quality_group_members (quality_profile_name, quality_group_name, quality_name, position)
SELECT 'FR-Films-Any', '1080p Fallback', q.name, 2 FROM qualities q WHERE q.name = 'WEBRip-1080p';
INSERT INTO quality_group_members (quality_profile_name, quality_group_name, quality_name, position)
SELECT 'FR-Films-Any', '1080p Fallback', q.name, 3 FROM qualities q WHERE q.name = 'HDTV-1080p';
INSERT INTO quality_group_members (quality_profile_name, quality_group_name, quality_name, position)
SELECT 'FR-Films-Any', '2160p Quality', q.name, 0 FROM qualities q WHERE q.name = 'Bluray-2160p';
INSERT INTO quality_group_members (quality_profile_name, quality_group_name, quality_name, position)
