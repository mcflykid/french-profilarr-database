...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required)
SELECT 'FR-MULTI-VFF', 'Pas de tag VF2', 'release_title', 'all', 1, 1
FROM custom_formats cf WHERE cf.name = 'FR-MULTI-VFF';
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required)
...
FROM custom_formats cf WHERE cf.name = 'FR-Team-QTZ';
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required)
SELECT 'FR-Team-QTZ-4KLight', 'QTZ', 'release_title', 'all', 0, 1
FROM custom_formats cf WHERE cf.name = 'FR-Team-QTZ-4KLight';
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required)
SELECT 'FR-Team-QTZ-4KLight', '4KLight', 'release_title', 'all', 0, 1
FROM custom_formats cf WHERE cf.name = 'FR-Team-QTZ-4KLight';
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required)
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name)
SELECT 'FR-MULTI-VFF', 'Pas de tag VF2', re.name FROM regular_expressions re WHERE re.name = 'FR-Regex-VF2';
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name)
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name)
SELECT 'FR-Team-QTZ-4KLight', 'QTZ', re.name FROM regular_expressions re WHERE re.name = 'QTZ';
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name)
SELECT 'FR-Team-QTZ-4KLight', '4KLight', re.name FROM regular_expressions re WHERE re.name = 'FR-Regex-4KLight';
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name)
...
-- Malus poids 1080p (Radarr) : conditions résolution + taille — préférence fichiers légers.
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required)
SELECT 'FR-Lourd-1080p', '1080p', 'resolution', 'radarr', 0, 1
FROM custom_formats cf WHERE cf.name = 'FR-Lourd-1080p';
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required)
SELECT 'FR-Lourd-1080p', 'Taille 5 Gio et plus', 'size', 'radarr', 0, 1
FROM custom_formats cf WHERE cf.name = 'FR-Lourd-1080p';
INSERT INTO condition_resolutions (custom_format_name, condition_name, resolution)
...
FROM custom_formats cf WHERE cf.name = 'FR-Tres-Lourd-1080p';
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required)
SELECT 'FR-Tres-Lourd-1080p', 'Taille 8 Gio et plus', 'size', 'radarr', 0, 1
FROM custom_formats cf WHERE cf.name = 'FR-Tres-Lourd-1080p';
INSERT INTO condition_resolutions (custom_format_name, condition_name, resolution)
